    ...
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">{{ $vehicle->brand }} {{ $vehicle->model }} — {{ $vehicle->registration_number }}</p>
            </div>
        </div>
    </x-slot>
                        ...
                        @if(!$vehicle->available)
                            <div class="bg-amber-50 border border-amber-200 rounded-xl p-4">
                                <p class="text-sm text-amber-700 font-medium">
                                    ⚠️ Ce véhicule est actuellement en mission. La disponibilité sera automatiquement mise à jour à la fin de la mission.
                                </p>
                            </div>
                        @else
                            <div class="flex items-center gap-3">
                                ...
                                <label for="available" class="text-sm font-semibold text-gray-700">
                                    Véhicule disponible
                                </label>
                            </div>
                        @endif
